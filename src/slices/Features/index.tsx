...
const Features = ({ slice }: FeaturesProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 max-w-5xl gap-x-8 gap-y-12 mx-auto sm:placeitems-start place-items-center">
        {slice.primary.features_group.map((item, index) => (
          <div
            key={index}
            className="max-w-sx grid sm:place-items-start place-items-center"
          >
