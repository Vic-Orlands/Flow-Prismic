...
type HerosectionDocumentDataSlicesSlice =
  | TextWithSliceSlice
  | CallToActionSlice
  | TestimonialsSlice
  | FeaturesSlice
 ...
 */
interface HerosectionDocumentData {
  /**
   * Title field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: herosection.title
   * - **Tab**: Main
   ...
   * - **Placeholder**: *None*
   * - **API ID Path**: herosection.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<HerosectionDocumentDataSlicesSlice> /**
   * Meta Title field in *Homepage*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: herosection.meta_title
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
   ...
   * - **API ID Path**: herosection.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: herosection.meta_image
   * - **Tab**: SEO & Metadata
 ...
 */
export type HerosectionDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithoutUID<
    Simplify<HerosectionDocumentData>,
    "herosection",
    Lang
  >;
...
/**
 * Item in *Features → Default → Primary → Features Group*
 */
export interface FeaturesSliceDefaultPrimaryFeaturesGroupItem {
  /**
   * Icon field in *Features → Default → Primary → Features Group*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.features_group[].icon
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  icon: prismic.SelectField<"calendar" | "bargraph" | "clover" | "hourglass">;

  /**
   * Title field in *Features → Default → Primary → Features Group*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.features_group[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Description field in *Features → Default → Primary → Features Group*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.features_group[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface FeaturesSliceDefaultPrimary {
  ...
  /**
   * Features Group field in *Features → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.features_group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  features_group: prismic.GroupField<
    Simplify<FeaturesSliceDefaultPrimaryFeaturesGroupItem>
  >;
}
...
/**
 * Primary content in *TextWithSlice → Default → Primary*
 */
export interface TextWithSliceSliceDefaultPrimary {
  /**
   * Heading field in *TextWithSlice → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *TextWithSlice → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Image field in *TextWithSlice → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
...
/**
 * Default variation for TextWithSlice Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
/**
 * Primary content in *TextWithSlice → Image Right → Primary*
 */
export interface TextWithSliceSliceImageRightPrimary {
  /**
   * Heading field in *TextWithSlice → Image Right → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *TextWithSlice → Image Right → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Image field in *TextWithSlice → Image Right → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
...
/**
 * Image Right variation for TextWithSlice Slice
 *
 * - **API ID**: `imageRight`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
/**
 * Slice variation for *TextWithSlice*
 */
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      HerosectionDocument,
      HerosectionDocumentData,
      HerosectionDocumentDataSlicesSlice,
      SettingsDocument,
      ...
      FeaturesSlice,
      FeaturesSliceDefaultPrimaryFeaturesGroupItem,
